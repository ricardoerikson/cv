...
\begin{minipage}[t]{0.4\textwidth} % 45% of the page width for name
  ...
  \colorbox{white}{{\HUGE\textcolor{black}{\textbf{\MakeUppercase{Ricardo}}}}} % First name

  \colorbox{white}{{\HUGE\textcolor{black}{\textbf{\MakeUppercase{Erikson}}}}} % Last name
...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
  ...
  \icon{Phone}{12}{+55 92 98226 1492}\\
  \icon{At}{12}{\href{mailto:ricardo@ricardoerikson.me}{ricardo@ricardoerikson.me}}\\
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
  ...
  % The first parameter is the FontAwesome icon name, the second is the box size and the third is the text
  % Other icons can be found by referring to fontawesome.pdf (supplied with the template) and using the word after \fa in the command for the icon you want
  \icon{Globe}{12}{\href{https://ricardoerikson.me}{ricardoerikson.me}}\\
  \icon{Github}{12}{\href{https://github.com/ricardoerikson}{github.com/ricardoerikson}}\\
  % \icon{Twitter}{12}{\href{https://twitter.com/@ricardoerikson}{@alyxvance}}\\
\end{minipage}
